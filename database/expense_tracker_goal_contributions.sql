...
CREATE TABLE `goal_contributions` (
  ...
  KEY `idx_goal_contributions_goal` (`goal_id`,`created_at`),
  CONSTRAINT `goal_contributions_ibfk_1` FOREIGN KEY (`goal_id`) REFERENCES `savings_goals` (`goal_id`) ON DELETE CASCADE
